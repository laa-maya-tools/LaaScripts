...
//Name: 2Bones.ma
//Last modified: Tue, Jul 19, 2022 08:21:45 AM
//Codeset: 1252
...
fileInfo "UUID" "FE416ED9-4F3F-3C01-D409-7794F7D221A7";
createNode transform -s -n "persp";
	...
	setAttr ".r" -type "double3" -41.738352732167854 40.600000000000477 2.5133740606853233e-14 ;
	setAttr ".rp" -type "double3" 0 -3.5527136788005009e-15 0 ;
	setAttr ".rpt" -type "double3" -1.5452505892932314e-15 3.4249056261108474e-15 3.196504372199856e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "556FCFD3-4F3C-A3EC-DF0B-7180EA72537E";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".ncp" 0.01;
	setAttr ".coi" 52.137828198702223;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5598F972-4354-12E9-DE8A-BEAE405CAD98";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "433BF0FE-462D-6533-6AEC-78938E8AFC4F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "1AEC7721-4FCE-555E-9293-8EA4DE6F221D";
createNode displayLayerManager -n "layerManager";
	rename -uid "8A996FE7-4D5C-EC35-1596-DFA2553BE776";
createNode displayLayer -n "defaultLayer";
	rename -uid "5877D6BD-435A-9374-8561-C6B010BC1AA5";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "09CC9073-453B-6FBE-4D65-FA9796B57B73";
...
createNode reference -n "FingerCRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" -type \"double3\" 6 0 9"
		2 "|input_00_link|output_00_link|FingerC:input_00_link" "translate" " -type \"double3\" 6 0 9"
...
createNode objectSet -n "LinkSet";
	rename -uid "43D2E326-4D9F-775F-2AF3-DAA8365EF472";
	setAttr ".ihi" 0;
	setAttr -s 2 ".dsm";
	setAttr -s 3 ".dnsm";
createNode objectSet -n "Secondaries";
	rename -uid "3AFC2EC1-42F5-289E-FA7B-798A1416670D";
	setAttr ".ihi" 0;
select -ne :time1;
	setAttr -av -k on ".cch";
