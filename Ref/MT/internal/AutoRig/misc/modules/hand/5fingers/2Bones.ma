...
//Name: 2Bones.ma
//Last modified: Tue, Jul 19, 2022 08:22:00 AM
//Codeset: 1252
file -rdi 1 -ns "FingerA" -rfn "FingerARN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma";
file -rdi 1 -ns "FingerB" -rfn "FingerBRN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma";
file -rdi 1 -ns "FingerC" -rfn "FingerCRN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma";
file -rdi 1 -ns "FingerD" -rfn "FingerDRN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma";
file -rdi 1 -ns "FingerE" -rfn "FingerERN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma";
file -r -ns "FingerA" -dr 1 -rfn "FingerARN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma";
file -r -ns "FingerB" -dr 1 -rfn "FingerBRN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma";
file -r -ns "FingerC" -dr 1 -rfn "FingerCRN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma";
file -r -ns "FingerD" -dr 1 -rfn "FingerDRN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma";
file -r -ns "FingerE" -dr 1 -rfn "FingerERN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma";
requires maya "2020";
...
fileInfo "UUID" "3A0BEAF6-4717-0B98-577C-B7A829C085E3";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "198E7412-44C1-4F07-CFC6-2B88588A7635";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CBB0DAE1-4073-59FD-323F-53A3664A4E23";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "320861B2-4A4A-2198-2D3D-7696616F595A";
createNode displayLayerManager -n "layerManager";
	rename -uid "6AA04020-404B-4C3B-EBF4-91B9913D4B93";
createNode displayLayer -n "defaultLayer";
	rename -uid "5877D6BD-435A-9374-8561-C6B010BC1AA5";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B62DDCC3-47F5-526C-3DEE-C5B121BB70BB";
...
createNode reference -n "FingerARN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		""
		5 3 "FingerARN" "FingerA:SkinJointsSet.message" "FingerARN.placeHolderList[7]" 
		""
		5 3 "FingerARN" "FingerA:ControlsSet.message" "FingerARN.placeHolderList[8]" 
		""
...
createNode reference -n "FingerBRN";
	...
	setAttr -s 5 ".fn";
	setAttr ".fn[0]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma{8}";
	setAttr ".fn[1]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma{4}";
	setAttr ".fn[2]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma{1}";
	setAttr ".fn[3]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma";
	setAttr ".fn[4]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma{1}";
	setAttr -s 7 ".phl";
	setAttr ".phl[4]" 0;
	setAttr ".phl[5]" 0;
	setAttr ".phl[6]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		"FingerBRN"
		"FingerBRN" 1
		5 3 "FingerBRN" "FingerB:TemplateSet.message" "FingerBRN.placeHolderList[4]" 
		""
		"FingerBRN" 12
		...
		5 4 "FingerBRN" "|Main_00_jnt|FingerB:Fk_00_jnt.inverseScale" "FingerBRN.placeHolderList[5]" 
		""
		5 4 "FingerBRN" "|Main_00_jnt|FingerB:Fk_00_jnt.parent" "FingerBRN.placeHolderList[6]" 
		""
		5 3 "FingerBRN" "FingerB:SkinJointsSet.message" "FingerBRN.placeHolderList[7]" 
		""
		5 3 "FingerBRN" "FingerB:ControlsSet.message" "FingerBRN.placeHolderList[8]" 
		""
		5 3 "FingerBRN" "FingerB:MetadataTemplate.message" "FingerBRN.placeHolderList[9]" 
		""
		5 3 "FingerBRN" "FingerB:LinkSet.message" "FingerBRN.placeHolderList[10]" 
		"";
lockNode -l 1 ;
createNode reference -n "FingerCRN";
	rename -uid "7AF553B3-4B1C-AF44-42BD-5B8A296C019E";
	setAttr -s 5 ".fn";
	setAttr ".fn[0]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma{7}";
	setAttr ".fn[1]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma{5}";
	setAttr ".fn[2]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma{2}";
	setAttr ".fn[3]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma{1}";
	setAttr ".fn[4]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma{2}";
	setAttr -s 7 ".phl";
	setAttr ".phl[4]" 0;
	setAttr ".phl[5]" 0;
	setAttr ".phl[6]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		"FingerCRN"
		"FingerCRN" 1
		5 3 "FingerCRN" "FingerC:TemplateSet.message" "FingerCRN.placeHolderList[4]" 
		""
		"FingerCRN" 12
		...
		5 4 "FingerCRN" "|Main_00_jnt|FingerC:Fk_00_jnt.inverseScale" "FingerCRN.placeHolderList[5]" 
		""
		5 4 "FingerCRN" "|Main_00_jnt|FingerC:Fk_00_jnt.parent" "FingerCRN.placeHolderList[6]" 
		""
		5 3 "FingerCRN" "FingerC:SkinJointsSet.message" "FingerCRN.placeHolderList[7]" 
		""
		5 3 "FingerCRN" "FingerC:ControlsSet.message" "FingerCRN.placeHolderList[8]" 
		""
		5 3 "FingerCRN" "FingerC:MetadataTemplate.message" "FingerCRN.placeHolderList[9]" 
		""
		5 3 "FingerCRN" "FingerC:LinkSet.message" "FingerCRN.placeHolderList[10]" 
		"";
lockNode -l 1 ;
...
createNode reference -n "FingerDRN";
	...
	setAttr -s 5 ".fn";
	setAttr ".fn[0]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma{6}";
	setAttr ".fn[1]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma{6}";
	setAttr ".fn[2]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma{3}";
	setAttr ".fn[3]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma{2}";
	setAttr ".fn[4]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma{3}";
	setAttr -s 7 ".phl";
	setAttr ".phl[4]" 0;
	setAttr ".phl[5]" 0;
	setAttr ".phl[6]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		"FingerDRN"
		"FingerDRN" 1
		5 3 "FingerDRN" "FingerD:TemplateSet.message" "FingerDRN.placeHolderList[4]" 
		""
		"FingerDRN" 12
		...
		5 4 "FingerDRN" "|Main_00_jnt|FingerD:Fk_00_jnt.inverseScale" "FingerDRN.placeHolderList[5]" 
		""
		5 4 "FingerDRN" "|Main_00_jnt|FingerD:Fk_00_jnt.parent" "FingerDRN.placeHolderList[6]" 
		""
		5 3 "FingerDRN" "FingerD:SkinJointsSet.message" "FingerDRN.placeHolderList[7]" 
		""
		5 3 "FingerDRN" "FingerD:ControlsSet.message" "FingerDRN.placeHolderList[8]" 
		""
		5 3 "FingerDRN" "FingerD:MetadataTemplate.message" "FingerDRN.placeHolderList[9]" 
		""
		5 3 "FingerDRN" "FingerD:LinkSet.message" "FingerDRN.placeHolderList[10]" 
		"";
lockNode -l 1 ;
createNode reference -n "FingerERN";
	rename -uid "FC98EBD3-4E74-1A6C-8723-7094F97D40CA";
	setAttr -s 5 ".fn";
	setAttr ".fn[0]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma{5}";
	setAttr ".fn[1]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma{7}";
	setAttr ".fn[2]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma{4}";
	setAttr ".fn[3]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma{3}";
	setAttr ".fn[4]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma{4}";
	setAttr -s 7 ".phl";
	setAttr ".phl[4]" 0;
	setAttr ".phl[5]" 0;
	setAttr ".phl[6]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		"FingerERN"
		"FingerERN" 1
		5 3 "FingerERN" "FingerE:TemplateSet.message" "FingerERN.placeHolderList[4]" 
		""
		"FingerERN" 12
		...
		5 4 "FingerERN" "|Main_00_jnt|FingerE:Fk_00_jnt.inverseScale" "FingerERN.placeHolderList[5]" 
		""
		5 4 "FingerERN" "|Main_00_jnt|FingerE:Fk_00_jnt.parent" "FingerERN.placeHolderList[6]" 
		""
		5 3 "FingerERN" "FingerE:SkinJointsSet.message" "FingerERN.placeHolderList[7]" 
		""
		5 3 "FingerERN" "FingerE:ControlsSet.message" "FingerERN.placeHolderList[8]" 
		""
		5 3 "FingerERN" "FingerE:MetadataTemplate.message" "FingerERN.placeHolderList[9]" 
		""
		5 3 "FingerERN" "FingerE:LinkSet.message" "FingerERN.placeHolderList[10]" 
		"";
lockNode -l 1 ;
...
createNode objectSet -n "LinkSet";
	rename -uid "0E8C5B82-4E79-8C4E-3E7F-F7809DD466D7";
	setAttr ".ihi" 0;
	setAttr -s 2 ".dsm";
	setAttr -s 5 ".dnsm";
createNode objectSet -n "Secondaries";
	rename -uid "F277CA24-46D7-B89B-EB3D-1AB34D4FA6C9";
	setAttr ".ihi" 0;
select -ne :time1;
	setAttr -av -k on ".cch";
...
connectAttr "FingerARN.phl[7]" "SkinJointsSet.dnsm" -na;
connectAttr "FingerARN.phl[8]" "ControlsSet.dnsm" -na;
connectAttr "FingerARN.phl[9]" "MetadataTemplate._postExecution[0]";
connectAttr "FingerARN.phl[10]" "LinkSet.dnsm" -na;
connectAttr "Main_00_jnt.s" "FingerBRN.phl[5]";
connectAttr "Main_00_jnt.msg" "FingerBRN.phl[6]";
connectAttr "FingerBRN.phl[7]" "SkinJointsSet.dnsm" -na;
connectAttr "FingerBRN.phl[8]" "ControlsSet.dnsm" -na;
connectAttr "FingerBRN.phl[9]" "MetadataTemplate._postExecution[1]";
connectAttr "FingerBRN.phl[10]" "LinkSet.dnsm" -na;
connectAttr "Main_00_jnt.s" "FingerCRN.phl[5]";
connectAttr "Main_00_jnt.msg" "FingerCRN.phl[6]";
connectAttr "FingerCRN.phl[7]" "SkinJointsSet.dnsm" -na;
connectAttr "FingerCRN.phl[8]" "ControlsSet.dnsm" -na;
connectAttr "FingerCRN.phl[9]" "MetadataTemplate._postExecution[2]";
connectAttr "FingerCRN.phl[10]" "LinkSet.dnsm" -na;
connectAttr "Main_00_jnt.s" "FingerDRN.phl[5]";
connectAttr "Main_00_jnt.msg" "FingerDRN.phl[6]";
connectAttr "FingerDRN.phl[7]" "SkinJointsSet.dnsm" -na;
connectAttr "FingerDRN.phl[8]" "ControlsSet.dnsm" -na;
connectAttr "FingerDRN.phl[9]" "MetadataTemplate._postExecution[3]";
connectAttr "FingerDRN.phl[10]" "LinkSet.dnsm" -na;
connectAttr "Main_00_jnt.s" "FingerERN.phl[5]";
connectAttr "Main_00_jnt.msg" "FingerERN.phl[6]";
connectAttr "FingerERN.phl[7]" "SkinJointsSet.dnsm" -na;
connectAttr "FingerERN.phl[8]" "ControlsSet.dnsm" -na;
connectAttr "FingerERN.phl[9]" "MetadataTemplate._postExecution[4]";
connectAttr "FingerERN.phl[10]" "LinkSet.dnsm" -na;
