...
//Name: 3Bones.ma
//Last modified: Tue, Jul 19, 2022 08:22:22 AM
//Codeset: 1252
...
file -rdi 1 -ns "FingerB" -rfn "FingerBRN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma";
file -rdi 1 -ns "FingerC" -rfn "FingerCRN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma";
file -rdi 1 -ns "FingerD" -rfn "FingerDRN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma";
file -rdi 1 -ns "FingerE" -rfn "FingerERN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma";
...
file -r -ns "FingerB" -dr 1 -rfn "FingerBRN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma";
file -r -ns "FingerC" -dr 1 -rfn "FingerCRN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma";
file -r -ns "FingerD" -dr 1 -rfn "FingerDRN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma";
file -r -ns "FingerE" -dr 1 -rfn "FingerERN" -typ "mayaAscii" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma";
requires maya "2020";
...
fileInfo "UUID" "AC5E9D1B-4357-3B90-0E7D-08B9841928F5";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C0136215-4002-E8A9-50A0-48A9D8A2F866";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3504ECF6-4BBB-DF02-0834-E1BBD0411750";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "7C5227C3-4465-CFA3-E2C4-C29DDDEAFA48";
createNode displayLayerManager -n "layerManager";
	rename -uid "E9315C5F-4653-8E60-399D-D89271FB45F3";
createNode displayLayer -n "defaultLayer";
	rename -uid "5877D6BD-435A-9374-8561-C6B010BC1AA5";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0EA72DA6-4AA5-55C3-05F5-988582B36102";
...
createNode reference -n "FingerBRN";
	...
	setAttr -s 5 ".fn";
	setAttr ".fn[0]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma{4}";
	setAttr ".fn[1]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma{1}";
	setAttr ".fn[2]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma";
	setAttr ".fn[3]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma{1}";
	setAttr ".fn[4]" -type "string" "C:/Users/dricobarral/Desktop/d_module/AutoRig/misc/modules/fkTwoBones.ma{1}";
	setAttr -s 7 ".phl";
	setAttr ".phl[4]" 0;
	setAttr ".phl[5]" 0;
	setAttr ".phl[6]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		""
		5 3 "FingerBRN" "FingerB:ControlsSet.message" "FingerBRN.placeHolderList[7]" 
		""
		5 3 "FingerBRN" "FingerB:SkinJointsSet.message" "FingerBRN.placeHolderList[8]" 
		""
...
createNode reference -n "FingerCRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		""
		5 3 "FingerCRN" "FingerC:ControlsSet.message" "FingerCRN.placeHolderList[7]" 
		""
		5 3 "FingerCRN" "FingerC:SkinJointsSet.message" "FingerCRN.placeHolderList[8]" 
		""
...
createNode reference -n "FingerDRN";
	...
	setAttr -s 4 ".fn";
	setAttr ".fn[0]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma{6}";
	setAttr ".fn[1]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma{3}";
	setAttr ".fn[2]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma{2}";
	setAttr ".fn[3]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma{3}";
	setAttr -s 7 ".phl";
	setAttr ".phl[4]" 0;
	setAttr ".phl[5]" 0;
	setAttr ".phl[6]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		""
		5 3 "FingerDRN" "FingerD:ControlsSet.message" "FingerDRN.placeHolderList[7]" 
		""
		5 3 "FingerDRN" "FingerD:SkinJointsSet.message" "FingerDRN.placeHolderList[8]" 
		""
...
createNode reference -n "FingerERN";
	...
	setAttr -s 4 ".fn";
	setAttr ".fn[0]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma{7}";
	setAttr ".fn[1]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/3Bones.ma{4}";
	setAttr ".fn[2]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/4Bones.ma{3}";
	setAttr ".fn[3]" -type "string" "C:/Perforcelocal/[ws00]/PRJ_05/GAME/Tools/MayaTools/internal/AutoRig/misc/modules/fk/2Bones.ma{4}";
	setAttr -s 7 ".phl";
	setAttr ".phl[4]" 0;
	setAttr ".phl[5]" 0;
	setAttr ".phl[6]" 0;
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		""
		5 3 "FingerERN" "FingerE:ControlsSet.message" "FingerERN.placeHolderList[7]" 
		""
		5 3 "FingerERN" "FingerE:SkinJointsSet.message" "FingerERN.placeHolderList[8]" 
		""
...
createNode objectSet -n "LinkSet";
	rename -uid "36C94C36-4141-92D8-BA58-28997AEC0187";
	setAttr ".ihi" 0;
	setAttr -s 2 ".dsm";
	setAttr -s 5 ".dnsm";
createNode objectSet -n "Secondaries";
	rename -uid "62038C34-48BC-1058-6452-C2B91C26B2BA";
	setAttr ".ihi" 0;
select -ne :time1;
	setAttr -av -k on ".cch";
...
connectAttr "FingerBRN.phl[7]" "ControlsSet.dnsm" -na;
connectAttr "FingerBRN.phl[8]" "SkinJointsSet.dnsm" -na;
...
connectAttr "FingerCRN.phl[7]" "ControlsSet.dnsm" -na;
connectAttr "FingerCRN.phl[8]" "SkinJointsSet.dnsm" -na;
...
connectAttr "FingerDRN.phl[7]" "ControlsSet.dnsm" -na;
connectAttr "FingerDRN.phl[8]" "SkinJointsSet.dnsm" -na;
...
connectAttr "FingerERN.phl[7]" "ControlsSet.dnsm" -na;
connectAttr "FingerERN.phl[8]" "SkinJointsSet.dnsm" -na;
