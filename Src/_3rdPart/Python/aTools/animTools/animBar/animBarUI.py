...
from aTools.generalTools import aToolsClasses;
import importlib as imp

imp.reload(aToolsClasses)
from aTools.commonMods import animMod;

imp.reload(animMod)
from aTools.generalTools import generalToolsUI;

imp.reload(generalToolsUI)
from aTools.commonMods import utilMod;

imp.reload(utilMod)
from aTools.commonMods import commandsMod;

imp.reload(commandsMod)
from aTools.commonMods import aToolsMod;

imp.reload(aToolsMod)
...
for loopMod in SUB_UI_MODS:
    exec("import aTools.animTools.animBar.subUIs.%s as %s; imp.reload(%s)" % (loopMod, loopMod, loopMod))
...
class AnimationBar_Gui(object):
    ...
    def createWin(self):
        ...
        # Main frame
        cmds.frameLayout("mainFrameLayout", labelVisible=False, borderVisible=False, w=10, marginHeight=0,
                         marginWidth=0, labelIndent=0, collapsable=False)
