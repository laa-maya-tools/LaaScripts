...
def toggleframePlaybackRange(onOff):
    ...
    if onOff:
        G.framePlaybackRangeScriptJobs.append(
            cmds.scriptJob(runOnce=False, killWithScene=False, event=('ToolChanged', framePlaybackRangeFn)))
        G.framePlaybackRangeScriptJobs.append(
            cmds.scriptJob(runOnce=False, killWithScene=False, event=('SelectionChanged', framePlaybackRangeFn)))
